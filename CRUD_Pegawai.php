    ...
    if($_GET['hal'] == "edit"){
        ...
        if ($edit){
            echo "<script> alert('Pengeditan Data Anda Telah Berhasil');
                            document.location='CRUD_Pegawai.php';
            </script>";
        }else{
                ...
                <div class="card-body">
                    <table class="table table-border table-striped">
                        ...
                        <tr>
                            ...
                            <td><?=$data['Jabatan']?></td>
                            <td>
                                <a href="CRUD_Pegawai.php?hal=edit&Id=<?=$data['Id']?>" class="btn btn-warning">Edit</a>
                                <a href="CRUD_Pegawai.php?hal=hapus&Id=<?=$data['Id']?>" onclick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
